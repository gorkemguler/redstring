...
window.VM_I18N = (function () {
  ...
  var STR = {
    tr: {
      ...
      tamEkran: "Tam ekran",
      tamEkranKapat: "Kapat",
      semaIndirSvg: "SVG indir",
      semaIndirPng: "PNG indir",
      semaBosUyari: "Şemada gösterilecek taraf yok.",
      tamEkranIpucu: "Kartları sürükleyin · çıkmak için Esc",
    ...
    en: {
      ...
      tamEkran: "Focus view",
      tamEkranKapat: "Close",
      semaIndirSvg: "Download SVG",
      semaIndirPng: "Download PNG",
      semaBosUyari: "There is nobody on the chart to export.",
      tamEkranIpucu: "Drag the cards · press Esc to leave",
